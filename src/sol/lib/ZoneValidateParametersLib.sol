...
library ZoneValidateParametersLib {
    ...
    function getZoneValidateParameters(
    ...
    ) internal view returns (ZoneValidateParameters memory zoneParameters) {
        ...
        // Create ZoneValidateParameters and add to zoneParameters array
        zoneParameters = ZoneValidateParameters({
            orderHash: orderHash,
            fulfiller: fulfiller,
    ...
    ) internal view returns (ZoneValidateParameters[] memory) {
        return _getZoneValidateParametersFromStruct(
            _getZoneValidateParametersStruct(
                advancedOrders,
                fulfiller,
                maximumFulfilled,
                seaport,
    ...
    function _getZoneValidateParametersStruct(
        AdvancedOrder[] memory advancedOrders,
        address fulfiller,
        uint256 maximumFulfilled,
        address seaport,
    ...
    function _getZoneValidateParametersFromStruct(
        ...
        return _finalizeZoneValidateParameters(details);
    }
    ...
    function _finalizeZoneValidateParameters(ZoneDetails memory zoneDetails)
        internal
        pure
        returns (ZoneValidateParameters[] memory zoneParameters)
    {
        zoneParameters = new ZoneValidateParameters[](
        ...
        for (uint256 i = 0; i < zoneDetails.advancedOrders.length; i++) {
            ...
            if (zoneDetails.orderHashes[i] != bytes32(0)) {
                // Create ZoneValidateParameters and add to zoneParameters array
                zoneParameters[i] = _createZoneValidateParameters(
    ...
    function _createZoneValidateParameters(
        bytes32 orderHash,
        OrderDetails memory orderDetails,
        AdvancedOrder memory advancedOrder,
        address fulfiller,
        bytes32[] memory orderHashes
    ) internal pure returns (ZoneValidateParameters memory) {
        return ZoneValidateParameters({
            orderHash: orderHash,
            fulfiller: fulfiller,
