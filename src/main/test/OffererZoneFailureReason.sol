...
enum OffererZoneFailureReason {
    ...
    Zone_revertsOnAuthorizeOrder, // Zone authorizeOrder call reverts
    Zone_revertsOnValidateOrder, // Zone validateOrder call reverts
    Zone_InvalidAuthorizeOrderMagicValue, // Zone authorizeOrder call returns invalid magic value
    Zone_InvalidValidateOrderMagicValue // Zone validateOrder call returns invalid magic value
}
